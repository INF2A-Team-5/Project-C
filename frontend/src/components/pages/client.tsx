...
function Client() {
  ...
  return (
    <div>
      ...
      <Table></Table>
      <Dialog.Root>
        <Dialog.Trigger className="h-12 w-80 px-8 rounded-md font-medium text-base text-white bg-primary-400 hover:bg-primary-600 dark:text-dark-500 dark:bg-primary-500 dark:hover:bg-primary-700">Create Ticket</Dialog.Trigger>
        <Dialog.Portal>
