...
namespace backend.Tests.ServicesTests
{
    public class MachineServiceTests
    {
        ...
        public async void MachineService_UpdateMachine_ReturnsNoContent(int id, string name, string description, int accountId)
        {
            ...
            // Act
            var result = await _fakeMachineService.UpdateMachine(id, new Machine { Name = newName, Description = newDescription, AccountId = accountId});
            // Assert
            Assert.NotNull(result);
        ...
        public async void MachineService_AddMachine_ReturnsMachine(string name, string description, int accountId)
        {
            // Arrange
