...
public static class DBSeeding
{
    public static void Seed()
    {
        ...
        Ticket ticket1 = new() { MachineId = 1, CustomerId = 1, Title = "test", Priority = "Critical", Status = "In Process", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket2 = new() { MachineId = 2, CustomerId = 1, Title = "test", Priority = "Non critical", Status = "In Process", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket3 = new() { MachineId = 3, CustomerId = 1, Title = "test", Priority = "Critical", Status = "Closed", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket4 = new() { MachineId = 4, CustomerId = 1, Title = "test", Priority = "Critical", Status = "In Process", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket5 = new() { MachineId = 5, CustomerId = 1, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket6 = new() { MachineId = 6, CustomerId = 1, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket7 = new() { MachineId = 7, CustomerId = 1, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket8 = new() { MachineId = 8, CustomerId = 1, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket9 = new() { MachineId = 9, CustomerId = 1, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket10 = new() { MachineId = 10, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket11 = new() { MachineId = 11, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket12 = new() { MachineId = 12, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket13 = new() { MachineId = 13, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket14 = new() { MachineId = 14, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket15 = new() { MachineId = 15, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket16 = new() { MachineId = 16, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket17 = new() { MachineId = 17, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket18 = new() { MachineId = 18, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket19 = new() { MachineId = 19, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket20 = new() { MachineId = 20, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket21 = new() { MachineId = 21, CustomerId = 2, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket22 = new() { MachineId = 22, CustomerId = 3, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket23 = new() { MachineId = 23, CustomerId = 3, Title = "test", Priority = "Non critical", Status = "Open", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket24 = new() { MachineId = 24, CustomerId = 2, Title = "test", Priority = "Critical", Status = "Closed", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
        Ticket ticket25 = new() { MachineId = 25, CustomerId = 2, Title = "test", Priority = "Critical", Status = "Closed", Date_Created = DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"), Problem = "test", HaveTried = "Test", MustBeDoing = "test", Solution = "Test", PhoneNumber = "0612345678" };
