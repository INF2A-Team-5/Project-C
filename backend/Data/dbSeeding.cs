...
public static class DBSeeding
{
    public static void Seed()
    {
        ...
        Ticket ticket1 = new() { Machine_Id = 3, Customer_Id = 1, Assigned_Id = 2, Priority = "Critical", Status = "In Process", Date_Created = DateTime.UtcNow, Solution = "Test", Pictures = "Test", PhoneNumber = "0612345678", Notes = "Test" };
        Ticket ticket2 = new() { Machine_Id = 3, Customer_Id = 1, Assigned_Id = 3, Priority = "Non critical", Status = "In Process", Date_Created = DateTime.UtcNow, Solution = "Test", Pictures = "Test", PhoneNumber = "0612345678", Notes = "Test" };
        Ticket ticket3 = new() { Machine_Id = 3, Customer_Id = 1, Assigned_Id = 2, Priority = "Critical", Status = "Closed", Date_Created = DateTime.UtcNow, Solution = "Test", Pictures = "Test", PhoneNumber = "0612345678", Notes = "Test" };
        Ticket ticket4 = new() { Machine_Id = 3, Customer_Id = 1, Assigned_Id = 2, Priority = "Critical", Status = "In Process", Date_Created = DateTime.UtcNow, Solution = "Test", Pictures = "Test", PhoneNumber = "0612345678", Notes = "Test" };
